 ...
 */
package com.nth.filepicker.internal.entity;
...
public final class SelectionSpec {
    ...
    public boolean onlyShowImages() {
        return showSingleMediaType && MimeTypeManager.Companion.ofImage().containsAll(mimeTypeSet);
    }

    public boolean onlyShowVideos() {
        return showSingleMediaType && MimeTypeManager.Companion.ofVideo().containsAll(mimeTypeSet);
    }
