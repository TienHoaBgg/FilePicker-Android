...
public class PreviewItemFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (item.isGif()) {
            SelectionSpec.getInstance().imageEngine.loadGifImage(Objects.requireNonNull(getContext()), size.x, size.y, image,
                    item.getContentUri());
        } else {
            SelectionSpec.getInstance().imageEngine.loadImage(Objects.requireNonNull(getContext()), size.x, size.y, image,
                    item.getContentUri());
        }
    }
