 ...
 */
package com.nth.filepicker.internal.model;
...
import com.nth.filepicker.internal.ui.widget.CheckView;
...
public class SelectedItemCollection {
    ...
    public IncapableCause isAcceptable(Item item) {
        if (maxSelectableReached()) {
            ...
            int maxSelectableTips = currentMaxSelectableTips(item);
            String cause;
            try {
                cause = mContext.getString(maxSelectableTips,maxSelectable);
    ...
    private int currentMaxSelectableTips(Item item) {
