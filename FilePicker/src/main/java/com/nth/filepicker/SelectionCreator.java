...
import com.nth.filepicker.engine.ImageEngine;
...
public final class SelectionCreator {
    private final NTHFilePicker mNTHFilePicker;
     ...
     *
     * @param NTHFilePicker   a requester context wrapper.
     * @param mimeTypes MIME type set to select.
     */
    SelectionCreator(NTHFilePicker NTHFilePicker, @NonNull Set<MimeType> mimeTypes, boolean mediaTypeExclusive) {
        mNTHFilePicker = NTHFilePicker;
     ...
     * <p>
     * It's a redundant API with {@link 'com.zhihu.matisse.NTHFilePicker#obtainResult'(Intent)},
    ...
    public void forResult(int requestCode) {
        Activity activity = mNTHFilePicker.getActivity();
        if (activity == null) {
            return;
        }
        ...
        Fragment fragment = mNTHFilePicker.getFragment();
        if (fragment != null) {
