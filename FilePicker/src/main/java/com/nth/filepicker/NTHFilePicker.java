...
/**
 * Entry for NTHFilePicker's media selection.
 */
public final class NTHFilePicker {

    private final WeakReference<Activity> mContext;
    private final WeakReference<Fragment> mFragment;

    private NTHFilePicker(Activity activity) {
        this(activity, null);
    }

    private NTHFilePicker(Fragment fragment) {
        this(fragment.getActivity(), fragment);
    }

    private NTHFilePicker(Activity activity, Fragment fragment) {
        mContext = new WeakReference<>(activity);
        mFragment = new WeakReference<>(fragment);
    }

    /**
     * Start NTHFilePicker from an Activity.
     * <p>
     * This Activity's {@link [Activity.onActivityResult] (int, int, Intent)} will be called when user
     * finishes selecting.
     *
     * @param activity Activity instance.
     * @return NTHFilePicker instance.
     */
    public static NTHFilePicker from(Activity activity) {
        return new NTHFilePicker(activity);
    }

    /**
     * Start NTHFilePicker from a Fragment.
     * <p>
     ...
     * @return NTHFilePicker instance.
     */
    public static NTHFilePicker from(Fragment fragment) {
        return new NTHFilePicker(fragment);
    }
